...
import com.github.continuedev.continueintellijextension.activities.flushTutorial
import com.github.continuedev.continueintellijextension.constants.getConfigJsonPath
import com.github.continuedev.continueintellijextension.constants.getEACopilotTutorialPath
        ...
        myJSQueryOpenInBrowser.addHandler { msg: String? ->
            ...
            when (messageType) {
                ...
                "showTutorial" -> {
                    ...
                    ide?.setFileOpen(getEACopilotTutorialPath())
                }
                "showVirtualFile" -> {
                    val data = data.asJsonObject
